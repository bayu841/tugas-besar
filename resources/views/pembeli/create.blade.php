    ...
    <div class="form-wrapper p-4 border rounded shadow-sm" style="width: 800px; ">
        <form action="{{ route('pembeli.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="alamat" class="form-control" id="alamat" style="width: 750px;" required>{{ old('alamat') }}</textarea>
            </div>
            <div class="mb-3">
                <label for="no_hp" class="form-label">No HP</label>
                <input type="text" name="no_hp" class="form-control" id="no_hp" value="{{ old('no_hp') }}" required style="width:750px; height:50px;">
            </div>
